...
export ISSUER=
export ISSUERKEY=
export BOUNTY_DATUM_FILE="<YOUR PATH TO>/gbte/gbte-plutus-v2/datum-and-redeemers/bounty-datum-example-01.json"
export REDEEMER_ACTION_FILE="<YOUR PATH TO>/gbte/gbte-plutus-v2/datum-and-redeemers/Distribute.json"
